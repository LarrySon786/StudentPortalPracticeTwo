...
public class ResetDatabase
{
    ...
    public ResetDatabase(CreateDisposeContextHelper createDispose, SignInManager<ApplicationUser> signInManager,
        // New seeders
    ...
    {
        await _createDispose.ExecuteAsync(async context =>
        {
