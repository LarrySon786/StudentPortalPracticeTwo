...
namespace StudentPortalPracticeTwo.Migrations
{
    ...
    [Migration("20260909134712_ApplicationEmailVerification")]
    partial class ApplicationEmailVerification
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudentPortalPracticeTwo.Database.Models.Authentication.ApplicationVerificationCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("DraftVerificationCode");
                });
            ...
            modelBuilder.Entity("StudentPortalPracticeTwo.Database.Models.SupportTicket.ResponseTicket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("StudentTicketInput")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.ToTable("ResponseTicket");
                });

            modelBuilder.Entity("StudentPortalPracticeTwo.Database.Models.SupportTicket.SupportTicket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("SupportTicketsDb");
                });

            modelBuilder.Entity("StudentPortalPracticeTwo.Database.Models.Users.Admin.PendingAdmin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("StudentPortalPracticeTwo.Database.Models.SupportTicket.ResponseTicket", b =>
                {
                    b.HasOne("StudentPortalPracticeTwo.Database.Models.SupportTicket.SupportTicket", "SupportTicket")
                        .WithMany("ResponseTicket")
            ...
            modelBuilder.Entity("StudentPortalPracticeTwo.Database.Models.SupportTicket.SupportTicket", b =>
                {
                    b.HasOne("StudentPortalPracticeTwo.Database.Models.Users.Students.Student", "Student")
                        .WithMany()
